    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "current_estimated_amount_minor",
                    models.PositiveBigIntegerField(blank=True, null=True),
                ),
                (
                    "manual_value_minor",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("range_low_minor__isnull", True),
                    ("range_high_minor__isnull", True),
                    ("range_low_minor__lte", models.F("range_high_minor")),
                    _connector="OR",
                ),
